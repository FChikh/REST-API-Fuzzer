...
var ts_structure_model_1 = require("ts-structure-model");
var ts_structure_model_2 = require("ts-structure-model");
...
function parseStruct(content, modules, mpth) {
    ...
    exports.tsm.Matching.visit(mod, function (x) {
        ...
        if (c) {
            var fields = {};
            var clazz = ts_structure_model_2.classDecl(c.name.text, isInterface);
...
function basicType(n, path) {
    ...
    return { typeName: n, nameSpace: namespace, basicName: basicName, typeKind: ts_structure_model_1.TypeKind.BASIC, typeArguments: [], modulePath: path };
}
function arrayType(b) {
    return { base: b, typeKind: ts_structure_model_1.TypeKind.ARRAY };
}
function unionType(b) {
    return { options: b, typeKind: ts_structure_model_1.TypeKind.UNION };
}
