...
describe('External type facets tests', function () {
    ...
    it("JSON External type facets test 9", function () {
        parserTests.testErrors(util.data("../data/rc2/jsonSchemaNegative6.raml"), ["It is not allowed to use external types as array component types in types and type properties declarations"]);
    });
    ...
    it("XSD External type facets test 9", function () {
        parserTests.testErrors(util.data("../data/rc2/xsdSchemaNegative6.raml"), ["It is not allowed to use external types as array component types in types and type properties declarations"]);
    });
